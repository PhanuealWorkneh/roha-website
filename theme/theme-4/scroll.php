  ...
  <div class="story-pin">
    ...
    <div class="story-stage">
      ...
      <div class="story-panel panel-1">
        <p class="story-copy" data-text="Africa deserves world-class healthcare — and we're building it."></p>
      </div>

      <div class="story-panel panel-2">
        <p class="story-copy" data-text="What started as a vision is becoming one of the continent's most ambitious healthcare projects."></p>
      </div>

      <div class="story-panel panel-3">
        <p class="story-copy" data-text="From the foundation to every last detail, Roha Health Ethiopia was built to stand apart."></p>
      </div>
      </div>
    </div>
  </div>
