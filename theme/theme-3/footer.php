		...
		<div class="row">
			...
			<div class="col-lg-2 col-md-6">
				<div class="footer-widget-content">
					...
					<div class="footer-widget-menu">
						<ul>
							<li><a href="#"><i class="bi bi-chevron-double-right"></i> About Roha Health</a></li>
							<li><a href="#"><i class="bi bi-chevron-double-right"></i> Governance</a></li>
							<li><a href="#"><i class="bi bi-chevron-double-right"></i> News &amp; Updates</a></li>
							<li><a href="#"><i class="bi bi-chevron-double-right"></i> Partners</a></li>
			...
			<div class="col-lg-3 col-md-6">
				<div class="footer-widget-content">
					...
					<div class="footer-widget-menu">
						<ul>
							<li><a href="#"><i class="bi bi-chevron-double-right"></i> Press Releases</a></li>
							<li><a href="#"><i class="bi bi-chevron-double-right"></i> Privacy Policy</a></li>
							<li><a href="#"><i class="bi bi-chevron-double-right"></i> Environmental, Social &amp; Governance</a></li>
							<li><a href="#"><i class="bi bi-chevron-double-right"></i> Milestones</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="footer-widget-contact">
					...
					<div class="footer-widget-address style_two">
						...
						<div class="footer-widget-address_text">
							<p>Our address:</p>
							<span>
								379 Cape Verde Street, A4 Building, 6th Floor,<br>
								Addis Ababa
							</span>
						</div>
					</div>
					...
					<div class="footer-widget-address">
						...
						<div class="footer-widget-address_text">
							<p>info@rohamedicalcampus.com</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-7">
				<div class="footer-bottom-content">
					<div class="footer-bottom-content-copy">
						<p>Copyright © <?= date('Y'); ?> Roha Medical Campus. All rights reserved.</p>
					</div>
				</div>
			</div>
			<div class="col-md-5 text-right">
				<div class="footer-bottom-content">
					<div class="footer-bottom-menu">
						<ul class="social-box" style="margin: 0px;">							
							<li class="linkedin"><a href="#" class="fab fa-linkedin-in"></a></li>
							<li class="linkedin"><a href="#" class="fab fa-x-twitter"></a></li>
