    ...
    <div class="wrap">
        <div class="sec-head">
            ...
            <div>
                ...
                <h2 style="color:#fff;">Ethiopia's first <em class="text-yellow">EDGE-certified</em> hospital design</h2>
            </div>
        </div>
        ...
        <div class="split-grid" style="margin-bottom: 4rem;">
            ...
            <div class="split-media img-pair">
                <div class="img-ph dark" style="aspect-ratio: unset; background: none;">
                    <img src="https://rohamedicalcampus.com/wp-content/uploads/2024/11/EDGE-certificate-1536x1097.jpg" alt="EDGE Certificate Placeholder" style="width:100%; height:100%; object-fit:cover; opacity: 0.9;">
        ...
        <div class="animated-stats-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 2rem; margin-bottom: 4rem;">
            <div class="stat-box" data-aos="fade-up" data-aos-delay="100">
                <h3 style="font-size: 3rem; color: var(--roha-accent-yellow); margin-bottom: 0.5rem;"><span class="odometer" data-target="35">0</span>%</h3>
            ...
            <div class="stat-box" data-aos="fade-up" data-aos-delay="200">
                <h3 style="font-size: 3rem; color: var(--roha-accent-yellow); margin-bottom: 0.5rem;"><span class="odometer" data-target="24">0</span>%</h3>
            ...
            <div class="stat-box" data-aos="fade-up" data-aos-delay="300">
                <h3 style="font-size: 3rem; color: var(--roha-accent-yellow); margin-bottom: 0.5rem;"><span class="odometer" data-target="21">0</span>%</h3>
        ...
        <div class="pillar-grid green-features-grid" style="grid-template-columns: repeat(3, 1fr);">
            <div class="pillar" data-aos="fade-up" data-aos-delay="100">
                ...
                <p class="text-body">Chilled water runs through pipes embedded in the building's own concrete structure, turning it into an efficient, low-energy cooling reservoir — the first large-scale use of this system in Ethiopia.</p>
            </div>
            <div class="pillar" data-aos="fade-up" data-aos-delay="200">
                ...
                <p class="text-body">A 1MW solar installation paired with battery storage will offset the hospital's reliance on the grid and lower its long-term operating costs.</p>
            </div>
            <div class="pillar" data-aos="fade-up" data-aos-delay="300">
                ...
                <p class="text-body">A 12,000-tree native forest surrounds the campus, acting as a natural carbon sink while creating a calm, biodiverse setting for patients and staff.</p>
            </div>
            <div class="pillar" data-aos="fade-up" data-aos-delay="400">
                ...
                <p class="text-body">Low-flow taps and showers, together with dual-flush toilets, are designed to meaningfully cut water consumption across the campus.</p>
            </div>
            <div class="pillar" data-aos="fade-up" data-aos-delay="500">
                ...
                <p class="text-body">A compact, leak-proof sewage treatment plant, along with low-emission systems for hospital waste, protects the surrounding environment.</p>
            </div>
            <div class="pillar" data-aos="fade-up" data-aos-delay="600">
                ...
                <p class="text-body">Natural light is maximized throughout the building, supported by occupancy-sensor and zoned lighting that automatically adjusts to reduce electricity use.</p>
            </div>
        </div>
