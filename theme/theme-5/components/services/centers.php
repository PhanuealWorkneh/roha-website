    ...
    <div class="wrap">
        ...
        <div class="services-center-grid">
            ...
            <div class="services-center-card">
                <div class="services-center-icon" style="background:rgba(169,39,36,.10);">
                    <svg viewBox="0 0 24 24" fill="none" stroke="#A92724" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <!-- Cardiology -->
            <div class="services-center-card">
                <div class="services-center-icon" style="background:rgba(255,135,57,.12);">
                    <svg viewBox="0 0 24 24" fill="none" stroke="#FF8739" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M12 20.5s-7.6-4.6-9.8-9C.9 8 2 4.5 5.2 3.6 7.6 3 9.9 4 12 6.5 14.1 4 16.4 3 18.8 3.6 22 4.5 23.1 8 21.8 11.5c-2.2 4.4-9.8 9-9.8 9z"/>
                        <path d="M3.5 12h3l2-3 2.5 5 2-4h3.5"/>
                    </svg>
                </div>
            ...
            <div class="services-center-card">
                <div class="services-center-icon" style="background:rgba(80,17,149,.10);">
                    <svg viewBox="0 0 24 24" fill="none" stroke="#501195" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M9 4.5c-2.6 0-4.5 2-4.5 4.3 0 1-.4 1.6-1 2.2-.7.7-1 1.4-.6 2.4.4 1 1.3 1.3 1.3 2.3 0 1.4 1.1 2.3 2.4 2.3.3 1.2 1.4 2 2.7 2 .9 0 1.6-.4 2.1-1"/>
                        <path d="M15 4.5c2.6 0 4.5 2 4.5 4.3 0 1 .4 1.6 1 2.2.7.7 1 1.4.6 2.4-.4 1-1.3 1.3-1.3 2.3 0 1.4-1.1 2.3-2.4 2.3-.3 1.2-1.4 2-2.7 2-.9 0-1.6-.4-2.1-1"/>
                        <path d="M12 4.5v14"/>
                    </svg>
                </div>
            ...
            <div class="services-center-card">
                <div class="services-center-icon" style="background:rgba(0,126,118,.10);">
                    <svg viewBox="0 0 24 24" fill="none" stroke="#007E76" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M9 21s-6-3.7-6-8.4C3 9.8 4.8 8 7 8c1.6 0 2.5.9 3 1.7"/>
                        <circle cx="16.5" cy="6.5" r="2.5"/>
                        <path d="M13 15.5c1 .8 2.2 1.2 3.5 1.2 2.8 0 5-2.1 5-4.7 0-1.3-.5-2.4-1.4-3.3"/>
                    </svg>
                </div>
                <h3 class="services-h3">Maternal &amp; Child Health</h3>
                <p class="services-center-lede">A dedicated floor built for safety and comfort, from routine births to advanced pediatric care.</p>
                <ul class="services-center-bullets">
            ...
            <!-- Orthopedics -->
            <div class="services-center-card">
                <div class="services-center-icon" style="background:rgba(0,56,84,.10);">
                    <svg viewBox="0 0 24 24" fill="none" stroke="#003854" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M6.5 4.5a2 2 0 112.6 3l-.4.4L17 16.2l.4-.4a2 2 0 112.6 3 2 2 0 01-3-2.6l-.4.4L8.3 8.3l-.4.4a2 2 0 01-3-2.6 2 2 0 011.6-1.6z"/>
                    </svg>
                </div>
                <h3 class="services-h3">Orthopedics</h3>
                <p class="services-center-lede">Restoring mobility and relieving pain, from sports injuries to complex trauma.</p>
                <ul class="services-center-bullets">
